...
class PPCActivityTypeItemAdd extends FormBase {
    ...
    public function getFormId() {
        return 'ppc_km_activities_type_item_add_form';
    }
    ...
    public function buildForm(array $form, FormStateInterface $form_state, $cop_group_id="") {
        ...
        $maxDisplayOrder = PPCActivitiesDatatable::getMaxCopItemDisplayOrder();
