...
class PPCActivityPhotoAdd extends FormBase {
    ...
    public function getFormId() {
        return 'ppc_km_activities_photo_add_form';
    }
    ...
    public function buildForm(array $form, FormStateInterface $form_state, $evt_id="") {
        ...
        $form['files'] = [
            ...
            '#required' => FALSE,
            '#upload_location' => 'private://ppcactivities/photo',
            '#multiple' => TRUE,
        ...
        $form['actions']['cancel'] = array(
            ...
            '#value' => t('Cancel'),
            '#prefix' => '&nbsp;',
            '#attributes' => array('onClick' => 'window.open(\'../ppcactivities_photo/' . $evt_id . '\', \'_self\'); return false;'),
    ...
    public function submitForm(array &$form, FormStateInterface $form_state) {
        ...
        $ActivitiesPhotoUri = 'private://ppcactivities/photo';
